...
class DeblurImageResponse extends Equatable {
  final bool? success;
  final String? imageUrl;
  final String? error;
  final String? cacheBase64;

  const DeblurImageResponse({this.success, this.imageUrl, this.error, this.cacheBase64});

  factory DeblurImageResponse.fromJson(Map<String, dynamic>? json) {
